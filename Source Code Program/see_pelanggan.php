...
<body>
    ...
    <nav class="navbar fixed-top navbar-dark" style="background-color: #0766ad;">
        <div class="container-fluid">
            <a class="navbar-brand" href="penjaga.php">Data Pelanggan </a>
    ...
    <div class="container-sm">
        <div class="row">
            <form action="" method="post">
                ...
                <br><a class="btn btn-primary p-1" href="insert_pelanggan.php">Tambah Pelanggan</a>
            </form>
        ...
        <table class="table">
            ...
            ?>
                <tr>
                    ...
                    <td><a class="btn btn-primary p-1 me-2" href="edit_pelanggan.php?idpelanggan=<?= $data["id_pelanggan"]; ?>">Edit</a>
                        <a class="btn btn-danger p-1" href="delete_pelanggan.php?idpelanggan=<?= $data["id_pelanggan"]; ?>" onclick="if(!confirm('Hapus data pelanggan ini?')){ event.preventDefault() }">Hapus</a>
                    </td>
                </tr>
            <?php } ?>
        </table>
